...
class Vil
	...
	def prv(type, cnt, player, msg)
		...
		s2 = %Q(<!--#{typehead}#{id}--><table class="message"><tr><td width="100" rowspan="2"><img src="img/#{pid}.png"></td><td colspan="2">#{s}</td></tr><tr><td valign="top"><div class="mes_#{type}"></div></td><td width="584"><div class="mes_#{type}_body0"><div class="mes_#{type}_body1">#{msg}</div></div></td></tr></table>\n)
		s2
	end
