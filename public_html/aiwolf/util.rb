...
def howl_wolf(howl_filename)
	%Q(<table class="message"><tr><td width="100" rowspan="2"><img src="img/#{howl_filename}.png"></td><td colspan="2" class="howl">狼の遠吠え</td></tr><tr><td width="16" valign="top"><img src="img/whisper00.jpg"></td><td width="584" valign="top"><div class="mes_whisper_body0"><div class="mes_whisper_body1">わおーん</div></div></td></tr></table>\n)
end
